...
public class ScheduleForUser extends AppCompatActivity {
    @Override
    ...
    public void retrieveUserData() {
        ...
        usersRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (date != null) {
                        for (DataSnapshot userSnapshot : dateSnapshot.getChildren()) {
                            ...
                            if (intent != null && intent.getExtras() != null && !intent.getExtras().isEmpty()) {
                                getName = intent.getStringExtra("fullName");
                                if (userOnDuty != null && userOnDuty.getName().equals(getName)) {
                ...
                ScheduleUserAdapter adapter = new ScheduleUserAdapter(userList);
                RecyclerView recyclerView = findViewById(R.id.recycler_view_schedule1);
                recyclerView.setLayoutManager(new LinearLayoutManager(ScheduleForUser.this));
